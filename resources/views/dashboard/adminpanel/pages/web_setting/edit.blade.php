                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('update.web-setting', $webSettings->id) }}" method="POST"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="site_title" value="{{ $webSettings->site_title }}"
                                            class="form-control" id="inputName" placeholder="Enter site title">
                                    </div>

                                    <div class="form-group">
                                        <label for="inputDesc">Meta Description</label>
                                        <textarea name="meta_description" id="inputDesc" rows="3" class="form-control">{{ $webSettings->meta_description }}</textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputFile">Logo</label><br>
                                        <figure class="figure">
                                            <img src="{{ url('/storage/app/public/settings/' . $webSettings->logo) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="site_url" value="{{ $webSettings->site_url }}"
                                            class="form-control" id="inputName" placeholder="https://www.sitename.com/">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="inputStatus">
                                            <option value="1"
                                                @if ($webSettings->status == 1) {{ __('selected') }} @endif>Active
                                            </option>
                                            <option value="0"
                                                @if ($webSettings->status == 2) {{ __('selected') }} @endif>Deactive
                                            </option>
                                        </select>
                                    </div>
                                </div>
