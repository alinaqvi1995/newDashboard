                            ...
                            <form action="{{ route('admin.create.credit_report') }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ssn" class="form-control" value="" id="ssn"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="date-selector">
                                            ...
                                            <input type="date" name="dob" class="form-control" data-date-format="YYYY MM DD" id="dob"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="houseNumber" class="form-control" value="" id="houseNumber"
                                            placeholder="Enter House Number" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="quadrant">Quadrant</label>
                                        <input type="text" name="quadrant" class="form-control" value="" id="quadrant"
                                            placeholder="Enter Quadrant" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="streetName">Street Name</label>
                                        <input type="text" name="streetName" class="form-control" value="" id="streetName"
                                            placeholder="Enter Street Name" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="streetType">Street Type</label>
                                        <input type="text" name="streetType" class="form-control" value="" id="streetType"
                                            placeholder="Enter Street Type" required>
                                    </div>
                                    <div class="form-group">
