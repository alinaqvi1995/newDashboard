...
@section('content')
    ...
    <div class="container">
        ...
        <form method="post" action="{{ route('admin.storeSkill') }}" enctype="multipart/form-data">
            @csrf
            @method('post')
            <input type="hidden" name="skill_id" value="{{ $skills->id }}">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="name" class="form-label fs-14 text-theme-primary fw-bold">Skill</label>
                    <input type="text" class="form-control fs-14 h-50px" name="name" value="{{ $skills->name }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea class="form-control fs-14 h-50px" name="description" value="" required>{{ $skills->description }}</textarea>
                    {{-- <input type="text" class="form-control fs-14 h-50px" name="description" value="{{ $skills->description }}" placeholder="Passing Year" required> --}}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
