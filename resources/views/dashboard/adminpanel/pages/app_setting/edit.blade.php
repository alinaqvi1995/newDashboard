                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('update.app-setting', $setting->id) }}" method="POST"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{ $setting->name }}"
                                            class="form-control" id="inputName" placeholder="Enter app name">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputFile">Logo</label><br>
                                        <figure class="figure">
                                            <img src="{{ url('/storage/app/public/settings/' . $setting->logo) }}"
